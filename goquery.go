...
func ExampleScrape_MetalReview() {
  ...
  if doc, e = goquery.NewDocument("http://www.baidu.com"); e != nil {
    panic(e.Error())
  }

  // Find the review items (the type of the Selection would be *goquery.Selection)
  doc.Find(".slider-row:nth-child(1) .slider-item").Each(func(i int, s *goquery.Selection) {
